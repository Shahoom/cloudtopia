...
// Find the start of the fields array inside export const BlogPosts = {
const matchStr = `export const BlogPosts: CollectionConfig = {`;
const exportIndex = content.indexOf(matchStr);
if (exportIndex === -1) {
  console.log("Could not find export const BlogPosts");
  process.exit(1);
}

const fieldsMatchStr = `\n  fields: [`;
const fieldsIndex = content.indexOf(fieldsMatchStr, exportIndex);

if (fieldsIndex === -1) {
  console.log("Could not find fields array in BlogPosts");
  process.exit(1);
}

const prefix = content.substring(0, fieldsIndex);
const suffix = `\n}\n`;
      ...
      tabs: [
        {
          ...
          fields: [
            { name: 'title', type: 'text', required: true },
            {
              ...
              required: true,
              unique: true,
              admin: { description: 'Auto-generated from the title when empty. Editable for SEO-safe URLs.' },
            },
            ...
            },
            {
              name: 'shortExcerpt',
              type: 'text',
              admin: { description: 'Very short card or featured-strip teaser.' },
            },
            {
              name: 'content',
              type: 'richText',
          ...
          fields: [
            {
              type: 'row',
              fields: [
                { name: 'featuredImageAlt', label: 'Alt text for accessibility', type: 'text', admin: { width: '100%' } },
              ]
            },
            {
              type: 'row',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              hasMany: true,
              admin: { description: 'Optional manual related posts. Otherwise the frontend uses same-category and same-tag articles.' },
            },
          ],
        },
        {
...
fs.writeFileSync('collections/BlogPosts.ts', prefix + newFields + suffix);
