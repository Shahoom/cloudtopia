...
For Next.js App Router specifically, our [multilingual SEO post](/en/blog/multilingual-seo-nextjs-arabic-english-turkish) covers how to wire `dir` via the locale segment cleanly.
