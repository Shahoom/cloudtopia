...
export default function ContentCreationPage() {
  ...
  const content = {
    en: {
      ...
      // Section 2: Magic Text - SEO optimized content
    ...
    ar: {
      ...
      // Section 2: Magic Text - SEO optimized content (Arabic)
      ...
      // Section 3: Text Generate Effect (Arabic)
