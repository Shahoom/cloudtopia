...
// Social Media Marketing Services Slides - Logical Order
const SLIDES_EN = [
  {
    id: "slide-1",
...
// Section 3: Creative Showcase with Reveal Wave Images
const CreativeShowcase = ({ locale }: { locale: string }) => {
  const isRTL = locale === 'ar'
