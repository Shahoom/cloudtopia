...
const digitalGrowthSupportServices: ServiceCard[] = [
    {
        name: 'Social Media Management',
        nameAr: 'إدارة وسائل التواصل الاجتماعي',
        tagline: 'Engage & Grow Your Audience',
    ...
    },
    {
        ...
        nameAr: 'صفحات هبوط للإعلانات المدفوعة',
        tagline: 'Turn Ad Clicks Into Leads',
        taglineAr: 'حوّل نقرات الإعلان إلى عملاء',
        description: 'High-converting landing pages built for paid campaigns with clear offers and tracking.',
        descriptionAr: 'صفحات هبوط عالية التحويل مبنية للحملات المدفوعة بعروض واضحة وتتبع دقيق.',
        icon: '/icons/services/Analytics Dashboard.png',
        gradient: 'from-amber-500 to-orange-600',
        glowColor: 'bg-lavender/50',
        href: '/services/paid-ads-landing-pages',
        features: ['Campaign Pages', 'A/B Testing', 'Conversion Tracking', 'Fast Loading'],
        featuresAr: ['صفحات حملات', 'اختبار A/B', 'تتبع التحويل', 'تحميل سريع'],
    },
    {
        name: 'Brand Identity',
    ...
    },
    {
        ...
        nameAr: 'أنظمة المحتوى',
        tagline: 'Content That Converts',
        taglineAr: 'محتوى يحقق النتائج',
        description: 'High-quality visual and written content systems that tell your brand story and feed every channel.',
        descriptionAr: 'أنظمة محتوى مرئي ومكتوب عالية الجودة تروي قصة علامتك وتغذي كل قناة.',
        icon: '/icons/services/Professional Content Creation.png',
        gradient: 'from-violet-500 to-indigo-600',
        glowColor: 'bg-lavender/50',
        href: '/content-creation',
        features: ['Content Calendar', 'Copywriting', 'Visual Assets', 'Reusable Templates'],
        featuresAr: ['تقويم محتوى', 'كتابة إعلانية', 'أصول مرئية', 'قوالب قابلة لإعادة الاستخدام'],
    },
    {
        name: 'Lead Generation Systems',
        nameAr: 'أنظمة توليد العملاء المحتملين',
    ...
    },
    {
        ...
        tagline: 'More From Existing Traffic',
        taglineAr: 'نتائج أكبر من زياراتك الحالية',
        description: 'Audit, test, and refine pages and funnels so more of your existing visitors take action.',
        descriptionAr: 'تدقيق واختبار وتحسين الصفحات والمسارات حتى يتخذ المزيد من زوارك الحاليين إجراءً.',
        icon: '/icons/services/Analytics Dashboard.png',
        gradient: 'from-teal-500 to-emerald-600',
        glowColor: 'bg-lavender/50',
        href: '/services/conversion-rate-optimization',
        features: ['Funnel Audit', 'A/B Testing', 'Heatmaps', 'UX Fixes'],
        featuresAr: ['تدقيق المسار', 'اختبار A/B', 'خرائط حرارية', 'تحسينات UX'],
    },
    {
        name: 'Email Marketing Automation',
        nameAr: 'أتمتة التسويق بالبريد الإلكتروني',
        tagline: 'Nurture On Autopilot',
        taglineAr: 'رعاية تلقائية للعملاء',
        description: 'Automated email journeys, segmentation, and broadcasts that keep leads and customers engaged.',
        descriptionAr: 'رحلات بريدية تلقائية، تقسيم الجمهور، ورسائل دورية تبقي العملاء المحتملين والحاليين على تواصل.',
        icon: '/icons/services/Analytics Dashboard.png',
        gradient: 'from-sky-500 to-blue-600',
        glowColor: 'bg-lavender/50',
        href: '/services/email-marketing-automation',
        features: ['Welcome Flows', 'Segmentation', 'Broadcasts', 'Performance Reports'],
        featuresAr: ['رسائل ترحيب', 'تقسيم الجمهور', 'رسائل دورية', 'تقارير الأداء'],
    },
]
