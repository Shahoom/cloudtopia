...
export default function ServicesPageClient({ t: pageT }: { t?: any }) {
    ...
    const heroTitle = t.services?.hero?.title || c.title
    const heroDesc = t.services?.hero?.description || c.description
    const heroBadge = t.services?.hero?.badge || c.badge
    const heroPreTitle = t.services?.hero?.preTitle || c.preTitle
