  ...
  return (
    <section className="w-full min-h-screen overflow-hidden flex flex-col items-center justify-center relative bg-lavender">
      <Floating sensitivity={-0.5} className="h-full">
        ...
        >
          <MotionImage
            ...
            quality={60}
            className="animate-hero-fade w-16 h-12 sm:w-24 sm:h-16 md:w-28 md:h-20 lg:w-32 lg:h-24 object-cover hover:scale-105 duration-200 transition-transform -rotate-[3deg] shadow-2xl rounded-xl"
        ...
        >
          <MotionImage
            ...
            quality={60}
            className="animate-hero-fade w-40 h-28 sm:w-48 sm:h-36 md:w-56 md:h-44 lg:w-60 lg:h-48 object-cover hover:scale-105 duration-200 transition-transform -rotate-12 shadow-2xl rounded-xl"
        ...
        >
          <MotionImage
            ...
            quality={60}
            className="animate-hero-fade w-40 h-40 sm:w-48 sm:h-48 md:w-60 md:h-60 lg:w-64 lg:h-64 object-cover -rotate-[4deg] hover:scale-105 duration-200 transition-transform shadow-2xl rounded-xl"
        ...
        >
          <MotionImage
            ...
            quality={60}
            className="animate-hero-fade w-40 h-36 sm:w-48 sm:h-44 md:w-60 md:h-52 lg:w-64 lg:h-56 object-cover hover:scale-105 duration-200 transition-transform shadow-2xl rotate-[6deg] rounded-xl"
        ...
        >
          <MotionImage
            ...
            quality={60}
            className="animate-hero-fade w-44 h-44 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 object-cover hover:scale-105 duration-200 transition-transform shadow-2xl rotate-[19deg] rounded-xl"
      ...
      <div className="flex flex-col justify-center items-center w-[250px] sm:w-[300px] md:w-[500px] lg:w-[700px] z-50 pointer-events-auto">
        ...
        <motion.div
          className="animate-hero-rise text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-center w-full justify-center items-center flex-col flex whitespace-pre leading-tight font-bold tracking-tight space-y-1 md:space-y-4"
        ...
        <motion.p
          className="animate-hero-rise text-lg sm:text-lg md:text-xl lg:text-2xl text-center text-slate-600 pt-4 sm:pt-8 md:pt-10 lg:pt-12 max-w-2xl"
          style={{ animationDelay: '0.5s' }}
        >
        ...
        <div className="flex flex-row justify-center space-x-4 rtl:space-x-reverse items-center mt-10 sm:mt-16 md:mt-20 lg:mt-20">
          <motion.button
            className="animate-hero-rise text-base sm:text-base md:text-lg lg:text-xl font-semibold tracking-tight text-white bg-primary-600 px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 lg:px-8 lg:py-3 rounded-full z-20 shadow-2xl hover:bg-primary-700 transition-colors"
            style={{ animationDelay: '0.7s' }}
            whileHover={{
              scale: 1.05,
              transition: { type: "spring", damping: 30, stiffness: 400 },
          ...
          <motion.button
            className="animate-hero-rise text-base sm:text-base md:text-lg lg:text-xl font-semibold tracking-tight text-primary-600 bg-lavender border-2 border-primary-200 px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 lg:px-8 lg:py-3 rounded-full z-20 shadow-lg hover:bg-lavender transition-colors"
            style={{ animationDelay: '0.7s' }}
            whileHover={{
              scale: 1.05,
              transition: { type: "spring", damping: 30, stiffness: 400 },
