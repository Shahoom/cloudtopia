...
export default async function IndustriesPage({ params }: PageProps) {
    ...
    return (
        <main className="relative min-h-screen bg-[#f7f3ea] text-neutral-950" dir={isRTL ? 'rtl' : 'ltr'}>
            <section className="relative overflow-hidden border-b border-neutral-950 px-4 pb-20 pt-32 sm:px-6 lg:px-8 md:pb-24 md:pt-40" data-header-theme="light">
                ...
                <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
                    ...
                    <h1 className="mb-8 max-w-4xl text-4xl font-black leading-[1.04] text-neutral-950 text-balance md:text-6xl lg:text-7xl">
                        {L.title}
                    </h1>
                    ...
                    <div className="border border-neutral-950 bg-neutral-950 p-5 text-white shadow-[10px_10px_0_rgba(14,165,233,0.24)]">
                        ...
                        <div className="grid gap-3">
                            {L.proofItems.map((item, index) => (
                                <div key={item} className="grid grid-cols-[2rem_1fr] items-center gap-3 border border-white/15 bg-white/8 px-3 py-3">
            ...
            <section className="relative px-4 py-14 sm:px-6 lg:px-8 md:py-20">
                <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[0.9fr_1.1fr]">
                    <div className="border border-neutral-950 bg-white p-7 shadow-[6px_6px_0_rgba(10,10,10,0.08)]">
                        <div className="mb-5 flex h-12 w-12 items-center justify-center bg-neutral-950 text-white">
                    ...
                    <div className="border border-neutral-950 bg-[#eef7ff] p-7">
                        <h2 className="text-2xl font-black text-neutral-950 md:text-3xl">{L.proofTitle}</h2>
                        <div className="mt-6 grid gap-3 sm:grid-cols-3">
                            {L.proofItems.map((item, index) => (
                                <div key={item} className="border border-neutral-950 bg-white p-4">
            ...
            <section className="relative px-4 py-20 sm:px-6 lg:px-8 md:py-24">
                <div className="mx-auto max-w-7xl">
                    <div className="mb-10 flex flex-col justify-between gap-4 border-b border-neutral-950 pb-5 md:flex-row md:items-end">
                        <div>
                        ...
                        <h2 className="text-3xl font-black tracking-tight text-neutral-950 text-balance md:text-4xl">{L.chooseTitle}</h2>
                        </div>
                        ...
                        {industrySlugs.map((slug, index) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="group grid min-h-[360px] border border-neutral-950 bg-white p-5 transition-[transform,box-shadow] duration-200 hover:-translate-y-1 hover:shadow-[8px_8px_0_rgba(10,10,10,0.16)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500"
                                >
                                    ...
                                    <h3 className="mb-3 text-2xl font-black leading-tight text-neutral-950">{localizedValue(industry.name, locale)}</h3>
                                    <p className="mb-5 line-clamp-3 text-sm leading-7 text-neutral-600">{localizedValue(industry.description, locale)}</p>

                                    <div className="mb-6 border-t border-neutral-950 pt-4">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {industry.serviceLinks.slice(0, 3).map((service) => (
                                                <span key={service.href} className="border border-neutral-200 bg-[#f7f3ea] px-2.5 py-1 text-[11px] font-bold text-neutral-700">
            ...
            <section className="relative bg-neutral-950 px-4 py-16 text-white sm:px-6 lg:px-8 md:py-20" data-header-theme="dark">
