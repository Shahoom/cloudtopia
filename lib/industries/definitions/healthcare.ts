  ...
  locales: {
    ...
    ar: {
      seo: {
        ...
        description:
          'تصمم كلاود توبيا مواقع رعاية صحية ثنائية اللغة، ورحلات حجز المرضى، والبوابات التي تديرها العيادة، وأنظمة تشغيل العيادات لرعاية مترابطة واضحة المسؤوليات.',
      },
      ...
      hero: {
        ...
        intro:
          'تصمم كلاود توبيا أنظمة رعاية صحية رقمية ثنائية اللغة تربط مواقع المرضى وحجز المواعيد والبوابات التي تديرها العيادة وسير عمل العيادات، من اكتشاف الخدمة والحجز إلى الزيارة والمتابعة.',
        primaryCta: {
      ...
      sections: [
        ...
        },
        {
          ...
          industryAnchors: [
            {
              industryId: 'education',
              label: 'استكشفوا رحلات التعليم متعددة الأدوار',
            },
            {
              industryId: 'government-public-sector',
