  ...
  locales: {
    ...
    ar: {
      seo: {
        ...
        description:
          'تصمم كلاود توبيا مواقع رعاية صحية ثنائية اللغة، ورحلات حجز للمرضى، وبوابات تديرها العيادة، وأنظمة تنظّم عملها اليومي، لتصبح الرعاية مترابطة ويعرف كل فريق دوره.',
      },
      ...
      hero: {
        ...
        intro:
          'تصمم كلاود توبيا أنظمة رعاية صحية رقمية ثنائية اللغة تصل بين المواقع التي يزورها المريض، وحجز المواعيد، والبوابات التي تديرها العيادة، وسير العمل اليومي داخلها: من لحظة البحث عن الخدمة والحجز، إلى الزيارة ثم المتابعة.',
        primaryCta: {
          label: 'لنرسم رحلة المريض لديكم',
          href: '/api/whatsapp?locale=ar',
        },
        secondaryCta: {
          label: 'استكشفوا تطبيقات الويب الموجهة للمرضى',
          serviceId: 'web-applications',
        },
        sceneSummary:
          'يلتقي مسار المريض بمسار العيادة عند الحجز والزيارة والمتابعة، وتبقى المسؤولية واضحة عند كل نقطة التقاء.',
        sceneStages: [
      ...
      sections: [
        {
          ...
          intro:
            'يحتاج المريض إلى طريق واضح يوصله إلى الخدمة المناسبة، ويحتاج فريق العيادة أن يصله الطلب بمعلومات تكفي لتحديد الخطوة التالية ومن يتولاها.',
          signals: [
            {
              id: 'access-friction',
              label: 'قد يتشتت الطريق من أول خطوة',
              description:
                'تتفرق الخدمات والأطباء والفروع وتعليمات الحجز بين أماكن متعددة، فيبقى على المريض أن يجمع الطريق بنفسه.',
            },
            {
              id: 'trust-clarity',
              label: 'الثقة تقوم على معلومات معتمدة',
              description:
                'تحتاج أوصاف الخدمات وتعليمات الاستعداد وقنوات التواصل إلى مسؤول محدد بالاسم داخل العيادة، وإلى مسار مراجعة واضح للجميع.',
            },
            {
              id: 'handoff-visibility',
              label: 'انتقال الطلب بين الفرق يحتاج إلى مسؤول واضح',
              description:
                'لا ينفع الطلب الرقمي إلا إذا عُرف الفريق الذي يستقبله، والمعلومات التي يحتاجها، والإجراء الذي يليه.',
            },
          ],
        },
        {
          ...
          intro:
            'يرافق النظام المريض عبر خطوات مفهومة يعرف تسلسلها، ولا يقدم القرارات السريرية على أنها نصيحة آلية.',
          stages: [
            {
              id: 'discovery',
              label: 'اكتشاف الخدمة المناسبة',
              description:
                'يجد المريض وصفاً معتمداً للخدمة ومكانها، والطريق الذي يسلكه للاستفسار أو الحجز.',
              actor: 'المريض',
            },
            {
              id: 'doctor-selection',
            ...
            },
            {
              ...
              description:
                'لا يجمع الطلب إلا التفاصيل المتفق عليها، ثم ينتقل إلى مرحلة تأكيد تتولاها العيادة.',
            ...
            },
            {
              ...
              description:
                'ترسل العيادة مكان الموعد المؤكد، والمستندات المطلوبة، والتعليمات المعتمدة للزيارة.',
              actor: 'فريق العيادة',
            },
            {
              id: 'visit',
              label: 'حضور الزيارة',
              description:
                'يحضر المريض وقد عرف موعده وما يحتاجه، ويبقى العمل السريري داخل أنظمة العيادة وضمن أدوارها المختصة.',
            ...
            },
            {
              ...
              description:
                'تقرر العيادة ما الذي يمكن مشاركته من معلومات، وعبر أي قناة، وبأي شروط للوصول.',
            ...
            },
            {
              ...
              description:
                'يظل الإجراء التالي واضحاً عبر طلب متابعة أو تذكير أو اتصال بالعيادة، دون أن يحل ذلك محل حكم المختص.',
        ...
        },
        {
          ...
          title: 'تظهر استمرارية الرعاية حيث يلتقي مسار المريض بمسار الفريق.',
          intro:
            'تقوم التجربة على مسارين متناسقين: ما يراه المريض، وما يتولاه فريق العيادة خلف كل خطوة ظاهرة.',
          stages: [
            {
              id: 'request',
              label: 'طلب الخدمة',
            ...
            },
            {
              id: 'review',
              label: 'مراجعة الطلب',
              description: 'يتولى مسؤول محدد بالاسم داخل العيادة مراجعة الطلب، ثم يحدد الإجراء التالي المناسب.',
              actor: 'منسق العيادة',
            },
            {
              id: 'booking',
              label: 'تأكيد الحجز',
              description: 'يتشارك المساران حالة الموعد المؤكدة نفسها ورسالة الاستعداد نفسها.',
              actor: 'المريض وفريق الحجز',
            },
            {
              id: 'visit',
              label: 'التسليم إلى فريق الرعاية',
        ...
        },
        {
          ...
          variant: 'stacked-layers',
          answers: ['buildable-system'],
          eyebrow: 'نطاق قابل للتنفيذ',
          title: 'رحلة الرعاية طبقات مترابطة، لكل طبقة منها مسؤول واضح.',
          intro:
            'يمكن أن يبدأ النطاق صغيراً، لكن كل طبقة تحتاج إلى مدخلات معتمدة، وجهة محددة تستلم منها، ونتيجة تستطيع العيادة مراجعتها.',
          layers: [
            {
              id: 'public-experience',
              label: 'التجربة العامة للمريض',
              description:
                'يشرح موقع ثنائي اللغة الخدمات المعتمدة والأطباء والفروع، ويدل كل مريض على خطوته التالية.',
              inputs: ['محتوى الخدمات المعتمد', 'ملفات الأطباء', 'فروع العيادة'],
              handoff: 'طلب خدمة أو حجز مبني على معلومات',
            ...
            },
            {
              ...
              description:
                'تسير طلبات الحجز وحالات التأكيد ورسائل الاستعداد على قواعد تضعها العيادة، ولكل منها مسؤول فيها.',
            ...
            },
            {
              ...
              description:
                'لا يرى أي فريق إلا العمل والمعلومات التي تخص مسؤوليته في المسار المتفق عليه.',
              inputs: ['خريطة الأدوار', 'حالات الطلب', 'مسؤوليات التصعيد'],
              handoff: 'مهمة لها مسؤول داخل العيادة',
            ...
            },
            {
              ...
              inputs: ['توثيق الواجهات المعتمد', 'المسؤول عن كل حقل', 'قرارات الوصول'],
        ...
        },
        {
          ...
          intro:
            'يتحدد المزيج النهائي بحسب مسار المريض، ومسؤوليات العيادة، والأنظمة القائمة، وأصغر انتقال متكامل يستحق أن يبدأ منه التحسين.',
          serviceIds: [
            'website-development',
            'web-applications',
            'business-systems-development',
          ...
          serviceAnchors: [
            ...
            {
              serviceId: 'content-creation',
              label: 'محتوى رعاية معتمد باللغتين',
            },
          ],
          relatedIndustryIds: ['education', 'government-public-sector'],
          industryAnchors: [
            {
              industryId: 'education',
              label: 'استكشفوا رحلات التعليم القائمة على الأدوار',
            },
            {
              industryId: 'government-public-sector',
              label: 'استكشفوا رحلات الخدمات العامة',
            },
          ],
        },
        {
          ...
          title: 'يُظهر التصميم الحدود التي تتولاها العيادة.',
          intro:
            'تصف الصفحة نموذج تشغيل مقترحاً، لا نصيحة طبية ولا ضماناً. وتبقى الصلاحيات والمحتوى والربط والقرارات السريرية بيد أصحابها المخوّلين.',
          items: [
            {
              id: 'permission-design',
              label: 'تصميم الصلاحيات',
              responsibility:
                'تسمي العيادة الأدوار، وتعتمد مستويات الوصول، وتقرر ما معلومات المريض التي تظهر في كل خطوة.',
              dependency: 'خريطة معتمدة للأدوار والوصول إلى المعلومات.',
              recovery: 'إيقاف المسار المتأثر، وإعادة قرار الوصول إلى صاحبه في العيادة.',
            },
            {
              id: 'content-ownership',
              label: 'المسؤولية عن المحتوى السريري',
              responsibility:
                'يعتمد مراجعون مخولون في العيادة أوصاف الخدمات وتعليمات الاستعداد ورسائل المرضى.',
              dependency: 'مسؤولون محددون بالاسم عن المحتوى العربي والإنجليزي، ومسار مراجعة واضح.',
              recovery: 'سحب المحتوى أو تعديله متى فقد اعتماد صاحبه.',
            },
            {
              id: 'source-systems',
              ...
              recovery: 'إبقاء الخطوة يدوية أو معزولة إلى أن يتأكد الربط.',
            },
            {
              id: 'clinical-boundary',
              label: 'حدود القرار السريري',
              responsibility:
                'يحتفظ المختصون المؤهلون بمسؤولية التشخيص والعلاج والمشورة الخاصة بحالة المريض.',
        ...
        },
        {
          ...
          intro:
            'تُكتب أسماء الخدمات وتعليمات الحجز وتوزيع الأدوار ورسائل المرضى بكل لغة على حدة، وتبقى بنية الرحلة واحدة في الاثنتين.',
          items: [
            {
              id: 'service-language',
              label: 'لغة خدمة أصيلة',
              description:
                'تُكتب أسماء الخدمات وشروح الرعاية على قدر ما يبحث عنه المريض بكل لغة، وما يفهمه، وما يتصرف على أساسه.',
            },
            {
              id: 'booking-instructions',
              label: 'تعليمات حجز مهيأة لكل لغة',
              description:
                'تبقى التواريخ والأماكن والمستندات المطلوبة ورسائل الخطوة التالية مقروءة في الكتابة من اليمين ومن اليسار.',
            },
            {
              id: 'content-governance',
              label: 'مسؤولية المحتوى في اللغتين',
              description:
                'يراجع النسختين مسؤولون محددون داخل العيادة، حتى لا تتحول إحداهما إلى صورة قديمة من الأخرى.',
            },
          ],
        },
        {
          ...
          intro:
            'أنفع نطاق أول هو رحلة مريض واحدة مكتملة، يُعرف فيها المسؤول عن المحتوى وعن الأنظمة وعن التشغيل.',
          items: [
            {
              id: 'existing-systems',
              question: 'هل يمكن ربط رحلة المريض بأنظمة العيادة الحالية؟',
              answer:
                'يمكن تصميمها وفق الواجهات وطرق الوصول التي تؤكدها العيادة ومزودوها. نحدد أولاً الحقول المطلوبة والأنظمة المسؤولة والبديل اليدوي، ثم نتفق على شكل الربط.',
            },
            {
              id: 'medical-advice',
              question: 'هل تقدم الرحلة الرقمية تشخيصاً أو نصيحة طبية؟',
              answer:
                'لا. تسهّل الوصول وتعرض المعلومات وتنقل الطلبات وتدير التواصل الذي تعتمده العيادة، أما التشخيص والعلاج والمشورة الخاصة بحالة المريض فتبقى عند المختصين المؤهلين.',
            },
            {
              id: 'privacy-ownership',
              question: 'من صاحب القرار في الخصوصية والصلاحيات؟',
              answer:
                'العيادة. هي التي تقرر الأدوار والصلاحيات ومدة الاحتفاظ بالمعلومات وحدود مشاركتها. ويأتي تصميم النظام ليكتب هذه القرارات صراحة وينفذ الحدود المعتمدة.',
            },
            {
              id: 'bilingual-delivery',
              question: 'هل يمكن تصميم الرحلتين العربية والإنجليزية معاً؟',
              answer:
                'نعم. تشترك اللغتان في خطوات الرحلة نفسها، وتُكتب أوصاف الخدمات والتعليمات والعناوين وتُراجع لكل جمهور على حدة، ويُضبط اتجاه القراءة لكل لغة.',
            },
            {
              id: 'starting-point',
              question: 'من أين تبدأ مؤسسة الرعاية الصحية؟',
              answer:
                'ابدؤوا برحلة مريض واحدة ذات قيمة عالية، وحددوا كل نقطة ينتقل فيها الطلب ومن يستلمه، ثم ارسموا أصغر نطاق نظام يدعم هذا المسار من أول خطوة حتى المتابعة.',
            },
          ],
        },
        {
          ...
          intro:
            'اختاروا مسار مريض واحداً، وسمّوا الفرق التي تتولاه والأنظمة التي يمر بها، ونحن نحوّل ذلك إلى موجز نظام رقمي محدد النطاق.',
          decisionCopy:
            'ابدؤوا برحلة واحدة مكتملة، لا بقائمة مزايا متفرقة.',
          primary: {
            label: 'لنرسم رحلة المريض لديكم',
            href: '/api/whatsapp?locale=ar',
          },
