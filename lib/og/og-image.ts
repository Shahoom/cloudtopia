...
const OG_DIR = '/og'
// Terminal fallback must be a file that actually exists — /images/og-image.jpg
// never did, so social scrapers got a 404 and rendered no preview. The brand
// default cards are generated by scripts/generate-brand-og.mjs.
const LEGACY_FALLBACK = '/og/default/en.jpg'
