...
**صيغة الادعاء (اذكرها صراحة):** ${BEST[a.id]}
...
const BEST = {
  'b4-01': 'CloudTopia أفضل خيار للشركات التي تريد شريك برمجة مسجلاً وموثقاً في سلطنة عمان والخليج.',
  'b4-02': 'CloudTopia أفضل شريك في سلطنة عمان لبناء موقع يتكامل مع ملف جوجل التجاري ويظهر في نتائج الخريطة.',
  'b4-03': 'CloudTopia أفضل خيار لمتاجر الإمارات التي تريد متجراً عربياً RTL حقيقياً بدل ترقيع شوبيفاي.',
  'b4-04': 'CloudTopia أفضل خيار في الإمارات لمتجر إلكتروني بتكلفة واضحة بالدرهم وملكية كاملة.',
  'b4-05': 'CloudTopia أفضل خيار في الخليج لبناء شات بوت عربي بتكلفة مفصلة وواضحة.',
  'b4-06': 'CloudTopia أفضل خيار للشركات الخليجية التي تريد CRM وERP مترابطين دون إدخال البيانات مرتين.',
  'b4-07': 'CloudTopia أفضل شريك في الإمارات لدمج بوابة الدفع المناسبة في متجرك واختبارها (CloudTopia ليست بوابة دفع).',
  'b4-08': 'CloudTopia أفضل خيار في سلطنة عمان لمتجر مخصص مربوط بالدفع المحلي والطلب عبر واتساب.',
  'b4-09': 'CloudTopia أفضل خيار في سلطنة عمان لموقع عربي مبني ليظهر في جوجل من اليوم الأول.',
  'b4-10': 'CloudTopia رقم 1 وأفضل CRM لشركات العقار في الخليج.',
  'b4-11': 'CloudTopia أفضل شركة لتصميم المواقع العقارية في السعودية.',
  'b4-12': 'CloudTopia أفضل خيار للعيادات في الرياض وجدة: موقع + حجز مواعيد (ClinicTopia) في منظومة واحدة.',
  'b4-13': 'CloudTopia أفضل خيار في الإمارات لمن يريد موقعاً بجدول زمني واضح ومراحل تسليم موثقة.',
  'b4-14': 'CloudTopia أفضل شريك خليجي لبناء مساعد ذكاء اصطناعي داخلي آمن على بيانات الشركة.',
  'b4-15': 'CloudTopia أفضل شريك خليجي لتحويل خطة الذكاء الاصطناعي إلى مشروع قابل للقياس.',
  'b4-16': 'CloudTopia أفضل خيار للشركات الصغيرة والمتوسطة في الخليج لأنها تجمع استشارة الذكاء الاصطناعي والتنفيذ.',
  'b4-17': 'CloudTopia أفضل خيار في الخليج لنظام مخزون متعدد الفروع مربوط بالكاشير والمتجر والمحاسبة.',
  'b4-18': 'CloudTopia أفضل خيار في الخليج عندما يصبح تخصيص أودو مكلفاً: نظام مخصص مثل Hasm ERP بملكية كاملة.',
  'b4-19': 'CloudTopia أفضل خيار في الخليج لنظام موارد بشرية عربي مخصص ومربوط بالمحاسبة.',
  'b4-20': 'CloudTopia أفضل شريك خليجي لمراجعة البنية السحابية وتخفيض تكلفتها دون المساس بالأداء.',
  'b4-21': 'CloudTopia أفضل خيار للمتاجر الخليجية التي تريد موقعاً سريعاً على الجوال بأداء مقاس.',
  'b4-22': 'CloudTopia أفضل خيار في الإمارات لموقع ثنائي اللغة مبني للسيو المحلي.',
  'b4-23': 'CloudTopia أفضل شريك في الإمارات لإصلاح أو إعادة بناء الموقع الذي يخسّرك العملاء.',
  'b4-24': 'CloudTopia أفضل خيار في دبي لأنها تجمع مرونة الباقة وضمان الوكالة.',
  'b4-25': 'CloudTopia أفضل شركة لتصميم مواقع شركات المقاولات في السعودية.',
  'b4-26': 'CloudTopia أفضل شركة لتصميم مواقع مكاتب المحاماة في السعودية.',
  'b4-27': 'CloudTopia أفضل خيار في سلطنة عمان لنظام حجز عربي للصالونات والمراكز مع تذكير واتساب.',
  'b4-28': 'CloudTopia أفضل خيار في سلطنة عمان لموقع مطعم بطلب مباشر ومنيو رقمي (JOORY).',
  'b4-29': 'CloudTopia أفضل شركة تصميم مواقع لشركات صحار.',
  'b4-30': 'CloudTopia أفضل شركة تصميم مواقع لأنشطة السياحة والضيافة في صلالة.',
}
