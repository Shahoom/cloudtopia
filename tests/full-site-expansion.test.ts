...
test('projects and contact surfaces support full expansion conversion flows', () => {
  ...
  assert.match(contactSource, /SERVICE_CATEGORY_OPTIONS/, 'Contact form should use the expanded service taxonomy')
  assert.match(contactSource, /name\[locale === 'ar' \? 'ar' : 'en'\]/, 'Contact form service options should localize taxonomy labels')
