...
const ScrambledTitle: React.FC<{ phrases: string[] }> = ({ phrases }) => {
    ...
    return (
        <h1
            ref={elementRef}
            className="text-white text-4xl sm:text-3xl md:text-5xl lg:text-6xl font-bold tracking-wider text-center leading-tight"
        ...
        <div className="relative w-full h-[100svh] bg-eerie overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 w-full px-6 sm:px-8">
                <div className="flex flex-col items-center gap-4 sm:gap-6">
                    ...
                    <p className="text-white/40 text-sm sm:text-sm md:text-base tracking-[0.2em] sm:tracking-[0.3em] font-light text-center">
                        {subtitle}
                    </p>
                </div>
            </div>
