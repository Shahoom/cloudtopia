import { Gauge, ShieldCheck, Star, MessageCircle, ThumbsUp } from 'lucide-react'

// Adapted for CloudTopia from the "features-8" bento block.
// - Light brand theme (white cards on the page's lavender) instead of the
//   dark/shadcn-token original, so it matches the geometric hero and the rest
//   of the site (the project's --card == --background, so bg-card is invisible).
// - Tailwind v3 syntax (the source used v4-only `bg-(--var)` / `rounded-tl-(--var)`).
// - Fully prop-driven: the bento layout + illustrations are shared across every
//   website sub-service, but the copy is hand-crafted per service.
...
export type FeaturesBentoContent = {
    eyebrow?: string
    heading?: string
    stat: { value: string; title: string }
    /** Exactly four feature cards. */
    items: FeatureItem[]
}

const CARD =
    'relative overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04)]'
...
export function FeaturesBento({
    ...
    const { eyebrow, heading, stat, items } = content
    const [c0, c1, c2, c3] = items
            ...
            <div className="mx-auto max-w-3xl px-6 lg:max-w-5xl">
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        {/* Card 1 — headline stat */}
                        <div className={`${CARD} col-span-full flex lg:col-span-2`}>
                            <div className="relative m-auto size-fit p-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    <svg className="absolute inset-0 size-full text-slate-200" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <span className="mx-auto block w-fit bg-gradient-to-r from-[#0284c7] to-[#6366f1] bg-clip-text text-5xl font-black text-transparent">
                                        {stat.value}
                                    </span>
                                </div>
                                <h3 className="mt-6 text-center text-2xl font-black text-[#0f172a]">{stat.title}</h3>
                            </div>
                        </div>

                        {/* Card 2 — fingerprint illustration */}
                        <div className={`${CARD} col-span-full sm:col-span-3 lg:col-span-2`}>
                            <div className="p-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-neutral-200 before:absolute before:-inset-2 before:rounded-full before:border before:border-neutral-100">
                                    <svg className="m-auto h-fit w-24" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            ...
                                            fill="currentColor"
                                        />
                                        <path className="text-[#0284c7]" d="M3 72H209" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
                                    </svg>
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h3 className="text-lg font-bold text-[#0f172a]">{c0?.title}</h3>
                                    <p className="text-sm leading-relaxed text-neutral-600">{c0?.description}</p>
                                </div>
                            </div>
                        </div>

                        {/* Card 3 — analytics/line illustration */}
                        <div className={`${CARD} col-span-full sm:col-span-3 lg:col-span-2`}>
                            <div className="p-6">
                                <div className="pt-2 lg:px-4">
                                    <svg className="w-full text-slate-300" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                                        ...
                                        />
                                        <defs>
                                            <linearGradient id="ct-feat-grad-a" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-[#0ea5e9]" stopColor="currentColor" stopOpacity="0.18" />
                                                <stop className="text-[#0ea5e9]" offset="1" stopColor="currentColor" stopOpacity="0" />
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </div>
                                <div className="relative z-10 mt-8 space-y-2 text-center">
                                    <h3 className="text-lg font-bold text-[#0f172a]">{c1?.title}</h3>
                                    <p className="text-sm leading-relaxed text-neutral-600">{c1?.description}</p>
                                </div>
                            </div>
                        </div>

                        {/* Card 4 — reliability + area chart mockup */}
                        <div className={`${CARD} col-span-full lg:col-span-3`}>
                            <div className="grid p-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-neutral-200 before:absolute before:-inset-2 before:rounded-full before:border before:border-neutral-100">
                                        <ShieldCheck className="m-auto size-5 text-[#0284c7]" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h3 className="text-lg font-bold text-[#0f172a]">{c2?.title}</h3>
                                        <p className="text-sm leading-relaxed text-neutral-600">{c2?.description}</p>
                                    </div>
                                </div>
                                <div className="relative -mb-6 -mr-6 mt-6 h-fit rounded-tl-2xl border-l border-t border-neutral-200 p-6 py-6 sm:ml-6">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border border-neutral-200"></span>
                                        <span className="block size-2 rounded-full border border-neutral-200"></span>
                                        <span className="block size-2 rounded-full border border-neutral-200"></span>
                                    </div>
                                    <svg className="w-full text-slate-300 sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                                        ...
                                        />
                                        <defs>
                                            <linearGradient id="ct-feat-grad-b" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                                                <stop className="text-[#0ea5e9]" stopColor="currentColor" stopOpacity="0.16" />
                                                <stop className="text-[#0ea5e9]" offset="1" stopColor="currentColor" stopOpacity="0.01" />
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </div>
                        ...
                        {/* Card 5 — engagement mockup */}
                        <div className={`${CARD} col-span-full lg:col-span-3`}>
                            <div className="grid h-full p-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-neutral-200 before:absolute before:-inset-2 before:rounded-full before:border before:border-neutral-100">
                                        <Gauge className="m-auto size-5 text-[#0284c7]" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h3 className="text-lg font-bold text-[#0f172a]">{c3?.title}</h3>
                                        <p className="text-sm leading-relaxed text-neutral-600">{c3?.description}</p>
                                    </div>
                                </div>
                                <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-neutral-200 sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-neutral-200 bg-white px-2 py-1 text-xs font-semibold text-neutral-500 shadow-sm">+38% leads</span>
                                            <div className="flex size-7 items-center justify-center rounded-full bg-gradient-to-br from-sky-400 to-cyan-500 text-white ring-4 ring-white">
                                                <Star className="size-3.5" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="flex size-8 items-center justify-center rounded-full bg-gradient-to-br from-indigo-400 to-violet-500 text-white ring-4 ring-white">
                                                <MessageCircle className="size-4" />
                                            </div>
                                            <span className="block h-fit rounded border border-neutral-200 bg-white px-2 py-1 text-xs font-semibold text-neutral-500 shadow-sm">5.0 rating</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-neutral-200 bg-white px-2 py-1 text-xs font-semibold text-neutral-500 shadow-sm">Repeat clients</span>
                                            <div className="flex size-7 items-center justify-center rounded-full bg-gradient-to-br from-blue-400 to-sky-500 text-white ring-4 ring-white">
