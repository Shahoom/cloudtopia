...
export function WebAppFeatures({ locale = 'en' }: WebAppFeaturesProps) {
    const isArabic = locale === 'ar'

    const content = {
        customizable: {
            title: isArabic ? 'قابل للتخصيص' : 'Customizable'
        },
        secure: {
            title: isArabic ? 'آمن بشكل افتراضي' : 'Secure by Default',
        ...
        fast: {
            title: isArabic ? 'سريع للغاية' : 'Lightning Fast',
            description: isArabic
        ...
        scalable: {
            title: isArabic ? 'قابل للتوسع عالمياً' : 'Globally Scalable',
            description: isArabic
        ...
        modern: {
            title: isArabic ? 'تقنيات حديثة' : 'Modern Tech Stack',
            description: isArabic
                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">{content.customizable.title}</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <Lock className="m-auto size-16 text-emerald-600" strokeWidth={1.5} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white">{content.secure.title}</h2>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">{content.fast.title}</h2>
                                    <p className="text-foreground">{content.fast.description}</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Globe className="m-auto size-5 text-emerald-600" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">{content.scalable.title}</h2>
                                        <p className="text-foreground">{content.scalable.description}</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Code2 className="m-auto size-6 text-emerald-600" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">{content.modern.title}</h2>
                                        <p className="text-foreground">{content.modern.description}</p>
                                    </div>
                                </div>
