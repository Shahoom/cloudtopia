...
export default function WhyCloudTopia() {
    ...
    const content = {
        ...
        ar: {
            ...
            title: 'مبني كما',
            titleHighlight: 'تتمنى أن يُبنى',
            description:
                'بدون حزم مفروضة، بدون تغييرات نطاق خفية، بدون قيود مورّد. طريقة شفافة للعمل مع فريق يشحن فعلاً.',
            reasons: [
                { title: 'مبني بشكل مرن', description: 'اختر بالضبط ما تحتاجه. لكل خدمة باقاتها الخاصة وتسعيرها الشفاف — بدون حزم مفروضة.' },
                { title: 'متعدد اللغات أصالة', description: 'العربية والإنجليزية والتركية كلغات افتراضية من الدرجة الأولى. صناعة ثنائية اللغة حقيقية، لا ترجمة إضافات.' },
                { title: 'نطاق ثابت، سعر ثابت', description: 'نطاق مكتوب وسعر ثابت قبل بدء التصميم. ما توقّعه هو ما تدفعه — بدون فواتير مفاجئة.' },
                { title: 'كل شيء ملكك', description: 'الكود، ملفات التصميم، الحسابات، والنطاق — 100% لك عند الإطلاق. بدون فخاخ تراخيص أو قيود.' },
                { title: 'رد سريع، أشخاص حقيقيون', description: 'رد خلال يوم عمل واحد من مهندس أو مصمم حقيقي، لا قمع مبيعات ولا بوت محادثة.' },
                { title: 'مبني ليدوم', description: 'مكدس تقني حديث، متاح الوصول افتراضياً، وخطط عناية تبقي مشروعك بصحة جيدة لسنوات — لا فقط أسبوع الإطلاق.' },
            ],
        },
        tr: {
