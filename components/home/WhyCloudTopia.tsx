...
export default function WhyCloudTopia() {
    ...
    const content = {
        ...
        ar: {
            ...
            title: 'نشتغل معك',
            titleHighlight: 'بالطريقة اللي تحبها',
            description:
                'ما في باقات مفروضة عليك، ولا تعديلات بتطلع فجأة، ولا ارتباط مقيّد معنا. شغل واضح، بصراحة كاملة، وفريق يسلّم فعلاً.',
            reasons: [
                { title: 'تختار اللي تحتاجه فقط', description: 'كل خدمة لها باقاتها وسعرها واضح. تبني مشروعك بالقطع اللي تحتاجها، وما تدفع زيادة مقابل شيء ما يفيدك.' },
                { title: 'عربي وإنجليزي وتركي — أصل لا ترجمة', description: 'نكتب ونصمم بكل لغة بشكلها الطبيعي. مو ترجمة فوق موقع إنجليزي، بل محتوى مبني لكل لغة على حدة.' },
                { title: 'سعر ونطاق متفق عليهم من البداية', description: 'قبل ما نبدأ التصميم، بتستلم نطاق مكتوب وسعر محدد. اللي توقّعه هو اللي تدفعه — من دون فواتير زيادة لاحقاً.' },
                { title: 'كل شي يصير لك', description: 'الكود، ملفات التصميم، الحسابات، والدومين — كلها باسمك من يوم الإطلاق. ما في قيود تراخيص ولا احتكار.' },
                { title: 'يردّ عليك إنسان، مو بوت', description: 'بتتواصل مع مهندس أو مصمم حقيقي، وبترجع لك خلال يوم عمل واحد. بدون قمع مبيعات وبدون ردود جاهزة.' },
                { title: 'مبني يستمر معك', description: 'أدوات حديثة وبنية تدوم. خطط متابعة بعد الإطلاق تخلي مشروعك شغّال وقوي لسنوات — مو بس أسبوع الإطلاق.' },
            ],
        },
        tr: {
