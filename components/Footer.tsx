...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-neutral-500 border-t border-neutral-100" dir={dir}>
              ...
              <div className={`flex ${dir === 'rtl' ? 'space-x-reverse space-x-4' : 'space-x-4'}`}>
                {socialLinks.map((social) => (
                  <Link
                    key={social.name}
                    href={social.href}
                    className="w-10 h-10 rounded-lg bg-neutral-50 border border-neutral-100 flex items-center justify-center text-neutral-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all duration-200"
