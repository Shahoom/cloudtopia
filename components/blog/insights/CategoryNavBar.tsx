  ...
  return (
    <div className="sticky top-[var(--header-height,72px)] z-30 border-b border-neutral-200 bg-white/95 backdrop-blur-sm">
      <div className="mx-auto flex max-w-7xl items-center gap-0 px-4 sm:px-6 lg:px-8">
        <nav className="flex min-w-0 flex-1 items-center overflow-x-auto" aria-label="Article categories">
          <Link
        ...
        <form
          ...
          className="ml-4 flex shrink-0 items-center overflow-hidden rounded-lg border border-neutral-200 bg-white"
        >
          <input
            name="q"
            defaultValue={search}
