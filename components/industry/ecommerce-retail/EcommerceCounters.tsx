...
/**
 * Count-up counters. An IntersectionObserver (threshold 0.3) fires the count-up
 * exactly once. Numbers render as plain integers server-side (no hydration
 * mismatch), then the client formats them per locale (Arabic-Indic digits for
 * `ar`) and animates 0 -> value. Under prefers-reduced-motion the final value is
 * shown immediately.
 */
export function EcommerceCounters({ stats, locale, caption, note }: EcommerceCountersProps) {
