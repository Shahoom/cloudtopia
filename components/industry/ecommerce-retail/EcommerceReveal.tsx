...
/**
 * Scroll reveal. An IntersectionObserver flips the element to its "in" class the
 * first time it enters the viewport (fade + translate).
 *
 ...
 * visible.
 */
export function EcommerceReveal({
  children,
  className,
  variant = 'up',
  stagger = false,
  id,
}: EcommerceRevealProps) {
