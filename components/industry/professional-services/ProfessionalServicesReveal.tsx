...
type ProfessionalServicesRevealProps = {
  children: ReactNode
  className?: string
...
/**
 * WOW.js-equivalent scroll reveal for the Showbiz port (the template references
 * .wow.fadeInUp but never actually loads wow.js). An IntersectionObserver flips
 * the element to its "in" class the first time it enters the viewport.
 *
 ...
 */
export function ProfessionalServicesReveal({
  children,
  className,
  variant = 'up',
  stagger = false,
  id,
}: ProfessionalServicesRevealProps) {
