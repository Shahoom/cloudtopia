...
/**
 * WOW.js-equivalent scroll reveal. An IntersectionObserver flips the element to
 * its "in" class the first time it enters the viewport (fade + translate).
 *
...
export function FintechReveal({
  ...
  useEffect(() => {
    ...
    if (alreadyVisible) {
      // In view at mount → stay visible, no entrance (avoids a flash).
      setState('in')
      return
    }
