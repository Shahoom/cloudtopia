...
type FintechScrollZoomCtaProps = {
  children: ReactNode
}

/**
 * CTA scroll-zoom — a faithful port of Paynext's `ctaScrollZoom()`: the card
 * eases (factor 0.1) from scale 1.1 to 1.0 as its centre approaches the
 * viewport centre. Disabled at <= 991px and under prefers-reduced-motion.
 */
export function FintechScrollZoomCta({ children }: FintechScrollZoomCtaProps) {
