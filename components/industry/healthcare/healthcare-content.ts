...
export const healthcareLandingCopy = {
  ...
  ar: {
    skip: 'الانتقال إلى محتوى قطاع الرعاية الصحية',
    industries: 'القطاعات',
    ...
    systemStrip: [
      ...
      { value: '04', label: 'العمل باللغتين' },
    ],
    principlesEyebrow: 'مبادئ التشغيل',
    principlesTitle: 'ما الذي تحتاجه تجربة رعاية صحية يمكن الاعتماد عليها؟',
    principlesIntro:
      'تجعل أقوى المنصات الصحية الوصول بسيطاً، وتُبقي كل قرار وكل انتقال للطلب وكل حد للمعلومات في يد العيادة.',
    principles: [
      {
        id: 'access-clarity',
        title: 'وضوح الوصول',
        description: 'يصل المريض إلى الخدمة ومكانها وخطوته التالية دون أن يجمع الرحلة بنفسه.',
        href: '#patient-experience',
      },
      {
        id: 'approved-information',
      ...
      },
      {
        ...
        description: 'لا يرى أحد إلا المعلومات والإجراءات التي تخص مسؤوليته.',
        href: '#trust-boundaries',
      },
      {
        id: 'owned-handoffs',
        title: 'تسليم له مسؤول',
        description: 'يصل الطلب ومعه معلوماته، ومن يستلمه، وما الخطوة التي تليه.',
        href: '#patient-clinic-journey',
      },
      {
        id: 'continuity',
    ...
    capabilitiesIntro:
      'تصل كلاود توبيا بين التجربة العامة وبين سير العمل الذي تتولاه العيادة، والربط مع أنظمتها، وإدارة المحتوى باللغتين.',
    securePortal: {
      id: 'secure-patient-portal',
      label: 'بوابة مريض آمنة',
      description:
        'تفتح بوابة تديرها العيادة أمام المريض مساراً معتمداً يصل به إلى المستندات المشتركة والتعليمات وإجراءات المتابعة.',
    },
    carouselPrevious: 'عرض القدرة السابقة في الرعاية الصحية',
    carouselNext: 'عرض القدرة التالية في الرعاية الصحية',
    clinicTopiaEyebrow: 'منتج من كلاود توبيا',
    clinicTopiaTitle: 'أفضل نظام لدينا لإدارة العيادات الحديثة.',
    clinicTopiaIntro:
      'يجمع كلينيك توبيا لفرق الرعاية أنظمة العيادة التشغيلية في مساحة عمل سحابية واحدة تبدأ بالعربية: من ملف المريض وجدول المواعيد، إلى الشؤون المالية والأقسام الداعمة للعمل السريري.',
    clinicTopiaCapabilities: [
      'المرضى',
      'المواعيد',
      'الفوترة والتأمين',
    ...
    sealMotto: 'وضوح • مسؤولية • استمرارية',
    dashboardToday: 'اليوم',
    dashboardClinicOps: 'تشغيل العيادة',
    carouselRegionLabel: 'معرض قدرات الرعاية الصحية',
