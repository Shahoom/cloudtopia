...
/**
 * WOW.js-equivalent scroll reveal (fadeInUp/Left/Right with the template's
 * 0/200/400/600ms stagger, applied via CSS nth-child delays). An
 * IntersectionObserver flips the element to its "in" class the first time it
 * enters the viewport.
 *
