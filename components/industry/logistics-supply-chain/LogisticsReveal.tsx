...
/**
 * Scroll reveal (AOS/WOW-equivalent). An IntersectionObserver flips the element
 * to its "in" class the first time it enters the viewport (fade + translate).
 *
 ...
 * visible.
 */
export function LogisticsReveal({
  children,
  className,
  variant = 'up',
  stagger = false,
  id,
}: LogisticsRevealProps) {
