...
/**
 * Scroll reveal (the template used WOW.js / animate.css). An IntersectionObserver
 * flips the element to its "in" class the first time it enters the viewport
 * (fade + translate).
 *
