...
export const travelHospitalityLandingCopy = {
  en: {
    ...
    heroBgAlt: '',
    heroCardAlts: [
      'A terrace swimming pool lined with white parasols and sun loungers under a clear sky.',
      'An aerial view of a harbour ringed by high-rise towers, with ferries at a wharf and a speedboat crossing the water.',
      'An overwater villa on stilts seen from a beach at sunset, a palm tree and a wooden sun lounger in the foreground.',
    ],
    ...
    solutions: [
      {
        ...
        imageAlt: 'A sailboat under full sail crossing a harbour in front of a steel arch bridge, with a city skyline behind.',
        width: 370,
        height: 297,
      },
      {
        ...
        imageAlt: 'A hotel lobby lounge with sofas and armchairs around low tables, under a row of pendant lamps.',
        width: 370,
        height: 297,
      },
      {
        ...
        imageAlt: 'A surfer crouching inside the barrel of a breaking turquoise wave.',
        width: 370,
        height: 297,
      },
      {
        ...
        imageAlt: 'A slice of chocolate cake with cream and a mint sprig on a white plate, two glasses of juice behind it.',
        width: 770,
        height: 500,
      },
    ],
    ...
    bandVideoPosterAlt: 'A man sitting on the sand leaning against the front wheel of a silver car on a beach, the sea behind him.',
    ...
    patterns: [
      {
        ...
        imageAlt: 'A hiker with trekking poles standing on a rocky outcrop above forested mountain ridges.',
        width: 370,
        height: 297,
      },
      {
        ...
        imageAlt: 'The open interior of a timber lodge with a high thatched roof, a cushioned bench between tree-trunk posts.',
        width: 370,
        height: 297,
      },
      {
        ...
        imageAlt: 'Two people holding hands in deck chairs on a beach, watching the sun set over the sea.',
        width: 370,
        height: 297,
      },
      {
        ...
        imageAlt: 'A terrace swimming pool lined with white parasols and sun loungers under a clear sky.',
        width: 370,
        height: 297,
      },
    ],
    ...
    storyImageAlt: 'A laptop, a leather notebook, a pen and a phone arranged on a dark wooden desk, seen from above.',
  ...
  ar: {
    ...
    heroBgAlt: '',
    heroCardAlts: [
      'مسبح على شرفة تصطف حوله مظلات بيضاء وكراسي استلقاء تحت سماء صافية.',
      'منظر جوي لميناء تحيط به أبراج شاهقة، مع عبّارات عند رصيف وزورق سريع يشقّ المياه.',
      'فيلا فوق الماء قائمة على دعامات تُرى من الشاطئ عند الغروب، وفي المقدمة نخلة وكرسي استلقاء خشبي.',
    ],
    ...
    solutions: [
      {
        ...
        image: '/images/industries/travel-hospitality/solution_booking.jpg',
        imageAlt: 'قارب شراعي بأشرعة مرفوعة يعبر ميناءً أمام جسر فولاذي مقوَّس، وخلفه أفق المدينة.',
        width: 370,
        height: 297,
      },
      {
        ...
        image: '/images/industries/travel-hospitality/solution_pms.jpg',
        imageAlt: 'ردهة فندق فيها أرائك وكراسي حول طاولات منخفضة، تحت صف من المصابيح المعلَّقة.',
        width: 370,
        height: 297,
      },
      {
        ...
        image: '/images/industries/travel-hospitality/solution_experiences.jpg',
        imageAlt: 'راكب أمواج ينحني داخل أنبوب موجة فيروزية متكسّرة.',
        width: 370,
        height: 297,
      },
      {
        ...
        image: '/images/industries/travel-hospitality/solution_guest.jpg',
        imageAlt: 'قطعة كعك بالشوكولاتة مع كريمة وورقة نعناع في طبق أبيض، وخلفها كوبا عصير.',
        width: 770,
        height: 500,
      },
    ],
    ...
    bandVideoPosterAlt: 'رجل يجلس على الرمل مستنداً إلى العجلة الأمامية لسيارة فضية على شاطئ، والبحر خلفه.',
    ...
    patterns: [
      {
        ...
        image: '/images/industries/travel-hospitality/pattern_tours.jpg',
        imageAlt: 'متنزهة بعصوَي مشي تقف على نتوء صخري فوق سلاسل جبلية مكسوّة بالغابات.',
        width: 370,
        height: 297,
      },
      {
        ...
        image: '/images/industries/travel-hospitality/pattern_property.jpg',
        imageAlt: 'الفضاء الداخلي المفتوح لنزل خشبي بسقف مرتفع من القش، ومقعد بوسائد بين أعمدة من جذوع الأشجار.',
        width: 370,
        height: 297,
      },
      {
        ...
        image: '/images/industries/travel-hospitality/pattern_loyalty.jpg',
        imageAlt: 'شخصان يتشابكان الأيدي على كرسيي استلقاء في الشاطئ، يشاهدان غروب الشمس فوق البحر.',
        width: 370,
        height: 297,
      },
      {
        ...
        image: '/images/industries/travel-hospitality/pattern_revenue.jpg',
        imageAlt: 'مسبح على شرفة تصطف حوله مظلات بيضاء وكراسي استلقاء تحت سماء صافية.',
        width: 370,
        height: 297,
      },
    ],
    ...
    storyImageAlt: 'حاسوب محمول ودفتر جلدي وقلم وهاتف مرتَّبة على مكتب خشبي داكن، من زاوية علوية.',
